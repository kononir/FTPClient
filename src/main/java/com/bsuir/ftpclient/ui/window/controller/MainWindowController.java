...
import com.bsuir.ftpclient.connection.ftp.data.manager.FileNamesManager;
...
public class MainWindowController {
    ...
    public void controlStartingCheckForFileNames(TreeView<String> fileTree)
            throws ConnectionExistException, ControlConnectionException, EstablishingDataConnectionException {
    ...
    private Connection establishDataConnection()
        ...
        try {
            ...
            throw new EstablishingDataConnectionException("Error when establish data connection", e);
        }
